        ...
        <nav className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              <div className="w-10 h-10 bg-primary-600 rounded-lg flex items-center justify-center dark:text-white text-black font-bold text-xl">
                C2M
              </div>
            ...
            <div className="hidden md:flex items-center space-x-4">
              ...
              <Link
                to="/register"
                className="bg-primary-600 hover:bg-primary-700 text-dark dark:text-white font-medium rounded-lg px-5 py-2.5 transition-colors duration-300 shadow-md hover:shadow-lg"
              >
                Get Started
              </Link>
            </div>
            <div className="md:hidden">
              {/* Mobile menu button with onClick handler */}
              <button 
          ...
          {mobileMenuOpen && (
            <div className="md:hidden mt-4 bg-white dark:bg-gray-800 rounded-lg shadow-lg py-2 px-4">
              <div className="flex flex-col space-y-3">
                <a
                  href="#features"
                  className="text-gray-600 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400 transition-colors duration-300 py-2"
                ...
                <Link
                  to="/login"
                  className="text-primary-600 dark:text-primary-400 hover:text-primary-700 dark:hover:text-primary-300 font-medium transition-colors duration-300 py-2"
                  onClick={() => setMobileMenuOpen(false)}
                >
                  Login
                </Link>
                <Link
                  to="/register"
                  className="bg-primary-600 hover:bg-primary-700 text-dark dark:text-white font-medium rounded-lg px-4 py-2 transition-colors duration-300 shadow-md hover:shadow-lg text-center"
                  onClick={() => setMobileMenuOpen(false)}
                >
                  Get Started
                </Link>
          ...
          <div className="lg:grid lg:grid-cols-2 lg:gap-8 items-center">
            <div className="mb-10 lg:mb-0">
              ...
              <div className="mt-10 flex flex-col sm:flex-row">
                <Link
                  to="/register"
                  className="flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-black dark:text-white bg-primary-600 hover:bg-primary-700 md:py-4 md:text-lg md:px-10 shadow-md hover:shadow-xl transition-all duration-300"
                >
                  Get Started
                </Link>
              ...
              <div className="relative lg:h-auto">
                ...
                <div className="relative bg-white dark:bg-gray-800 p-6 rounded-xl shadow-xl overflow-hidden border border-gray-200 dark:border-gray-700">
                  ...
                  <div className="mt-6 flex">
                    ...
                    />
                    <button className="bg-primary-600 text-black dark:text-white px-4 py-2 rounded-r-lg hover:bg-primary-700 transition-colors duration-300">
                      Send
                    </button>
                  </div>
                </div>
          ...
          <div className="mt-16">
            <div className="lg:grid lg:grid-cols-3 lg:gap-8">
              ...
              <div className="relative p-5">
                <div className="flex items-center justify-center w-12 h-12 rounded-md bg-primary-500 text-black dark:text-white mb-4 lg:mb-8 text-xl font-bold">
                  1
                </div>
